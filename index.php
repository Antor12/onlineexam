...
function validateForm() {
  ...
  var br = document.forms["form"]["Class"].value;
  if (br == "") {
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="rollno" name="rollno" placeholder="Enter Your Class Roll"form-control input-md" type="text" value="<?php
...
<div class="form-group">
  ...
  <div class="col-md-12">
    <select id="Class" name="Class" placeholder="Select your Class" class="form-control input-md" >
   <option value="" <?php
if (!isset($_GET['Class']))
    echo "selected";
?>>Select Class</option>
...
<div class="col-md-3 box">
<span href="#" data-target="#login" style="color:lightyellow">Organized by Antor Sharkar<br><br></span>
</div>
